...
<div class="container">
    <div class="row">
        <form id="J_Form" class="form-horizontal span24" method="post" action="/index.php/admin/Member/vipapproval.html">
             <div class="row">
                <div class="row">
			...
			<?php foreach($data as $k=>$v): ?>
  			<tr>
  				...
  				<td><?php echo $v['tel']?></td>
                                <td><a href="#" onclick="show()" style="font-size:15px; color:#00f; font-weight:bold;">同意</a>
                                    
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    <a href="<?php echo U('del',array('memid'=>$v['memberid']));?>" style="font-size:15px; color:#00f; font-weight:bold;">拒绝</a>
                                </td>
        ...
        <tr>
               <td colspan="5" style="font-size:15px;  color: #36c; "> <?php echo $pagea; ?></td>
       </tr>
		...
		<div style="height:30px;font-size:16px;text-align: center;background-color:rgb(31, 164, 223);padding-top: 8px;color:#fff;"><b>
                    开通VIP
                    </b></div>
		...
		<div class="row">
          <div class="control-group span15 ">
            ...
            <div id="range" class="controls bui-form-group"  data-rules="{dateRange:true}">
              <input name="start_date" class="calendar"   data-rules="{required:true}"  type="text"><label>&nbsp;-&nbsp;</label><input name="end_date" class="calendar"   data-rules="{required:true}"  type="text"><a href="<?php echo U('edit',array('memid'=>$v['memberid']));?>" style="font-size:15px; color:#00f; font-weight:bold;
                  margin-left: 120px;  
  line-height: 18px;">保存</a>
            </div>
          </div>
        </div>
		<div class="none">
