...
.top2 h2{
 ...
 <body>
    ...
    <div>
       ...
       <form id="J_Form" class="form-horizontal span24" method="post" action="/index.php/admin/Order/index.html">
    ...
    <div class="row" >
        ...
        <div class="row">
          <div class="control-group span15">
            <label class="control-label" style="margin-left:-45px; ">订单查询：</label>
			<div style="color:grey;"><select  style="width:70px;float:left;font-size:14px;color: #aaa;" name="" id=""><option value="">全国</option></select></div>
            <div class="controls bui-form-group-select"  data-type="city" style="margin-left:0px;">
			
              <select  style="width:95px;float:left;font-size:14px;color: #aaa;" class="input-small" name="province" value="<?php echo $province; ?>">
                <option>请选择省</option>
              </select>
