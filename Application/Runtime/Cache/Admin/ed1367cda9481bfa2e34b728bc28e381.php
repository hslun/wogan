...
<script type="text/javascript" src="/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
 ...
 <body>
  ...
  <div class="container">
    <div class="row">
        <form id="J_Form" class="form-horizontal span24" method="post" action="/index.php/Admin/Advert/add.html" enctype="multipart/form-data" >
            <div>
                广告名称:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="title"><br/><br/>
                <input type="file" name="img" ><br/><br>
            </div>
         <div class="row">
          <div class="control-group span15 ">
            <label  style="margin-left:-42px;" class="control-label">开通时间：</label>
            ...
            <div>
                广告类型:&nbsp;&nbsp;&nbsp;&nbsp;<select name="flag" style="width:100px;"><option value="1">文字广告</option><option value="2">左侧广告吧</option></select>&nbsp;&nbsp;&nbsp;&nbsp;
