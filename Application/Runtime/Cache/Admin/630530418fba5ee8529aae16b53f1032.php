...
<script type="text/javascript" src="/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
 ...
 <body>
  ...
  <div class="container">
    <div class="row">
        <form id="J_Form" class="form-horizontal span24" method="post" action="/index.php/Admin/Advert/edit/id/40.html" enctype="multipart/form-data" >
            <div>
                广告名称:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="title" value="<?php echo $data['title']?>"><br/><br/>
                <input type="file" name="img" >
                <?php showImage($data['smlogo']);?>
            </div>
         <div class="row">
