...
{
	public function abc(){
		$data = $this->alias('a')->field('a.id,a.ProvinceName,b.name,b.email,b.tel,b.create_date,b.start_date,b.end_date,b.balance,b.account')
		->JOIN('
	LEFT JOIN __AGENT__ b ON a.id=b.provinceid
			')->select();
