...
<html>
 ...
 <body>
  ...
  <div class="container">
    <div class="row">
        <form id="J_Form" class="form-horizontal span24" method="post" action="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/randstr';?>">
      ...
      <input type="hidden" name="provinceid" value="<?php echo $_GET['provinceid']?>">
		  <input type="hidden" name="districtid" value="<?php echo $_GET['districtid']?>">
		  <br/><br/>
