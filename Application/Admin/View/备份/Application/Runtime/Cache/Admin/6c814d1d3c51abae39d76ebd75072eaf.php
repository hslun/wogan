...
<html>
    ...
    <body>
        <form method="post" action="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/add';?>" onsubmit="return show();">
        <div class="box">
        <input type="hidden" name="provinceid" value="<?php echo $_POST['provinceid']?>">
      <input type="hidden" name="districtid" value="<?php echo $_POST['districtid']?>">
			...
			<button type="submit" class="button button-primary" onclick="">确认开通</button>
  ...
  <script type="text/javascript">
	function show(){
		if(confirm("请保存好初始密码,如丢失密码请联系客服")){
