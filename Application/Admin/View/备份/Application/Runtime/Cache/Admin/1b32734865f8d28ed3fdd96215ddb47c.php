...
body{
 ...
 <body>
  ...
  <div class="container">
    <div class="row">
      <form id="J_Form" class="form-horizontal span24" style="width:1150px" method="post" action="/abc.php?s=admin/Agent/agent.html">
        <div class="row">
		...
		<table style="margin:5px auto;">
			...
			<?php  foreach($pname as $k3=>$v3):?>
				...
				<td style="<?php if((!empty($v3['name']))||(empty($v3['name']) && time()>strtotime($v3['start_date'])&&time()<strtotime($v3['end_date']))) {echo 'color:#f60';} ?>">
				 	<?php  if((!empty($v3['name']))&&(time()>strtotime($v3['start_date'])&&time()<strtotime($v3['end_date']))) {echo "已开通";} else if((!empty($v3['create_date']))||(!empty($v3['account'])&&time()<strtotime($v3['start_date']))||(!empty($v3['account'])&&time()>strtotime($v3['end_date']))){ echo "待激活"; }else if(empty($v3['account'])){echo "未开通";} ?></td>
				<td>
				 <?php if(!empty($v3['create_date']) && time()>strtotime($v3['start_date'])&&time()>strtotime($v3['end_date'])): ?>
                                    <a href="#" style="margin-right:17px;color:green;">
                                        续费
                                    </a><a href="#">暂停</a><a onclick="return confirm('确定要关闭吗？');"  href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/del/id/'.$v3['id'];?>"style="margin-left:20px;">关闭</a>
				<?php endif; ?>
                                    ...
                                    <a href="#" style="margin-left:-12px;color:grey;">
                                        已开通
                                    </a><a style=" margin-left: 14px;" href="#">暂停</a><a onclick="return confirm('确定要关闭吗？');"  href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/del/id/'.$v3['id'];?>"style="margin-left:20px;">关闭</a>
				<?php endif; ?>
                                 <?php if(empty($v3['create_date'])): ?>
                                    <a href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/add/city/'.$v3['CityName']."/provinceid/".$v3['ProvinceID'];?>" style="margin-right:20px;">
                                        开通
				...
				<?php endif; ?>
                                <?php if(!empty($v3['name']) &&(time()>strtotime($v3['start_date']))&&(time()<strtotime($v3['end_date']))): ?>
                                    <a style="margin-left:-12px;" href="#" style="margin-right:20px;">
                                        已开通
                                    </a><a style=" margin-left: 14px;" href="#">暂停</a><a href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/del/id/'.$v3['id'];?>"style="margin-left:20px;">关闭</a>
				<?php endif; ?>
				 </td>
		...
		<td>
				 <?php if(!empty($v['create_date']) && time()>strtotime($v['start_date'])&&time()>strtotime($v['end_date'])): ?>
                                    <a href="<?php echo U('show',array('id'=>$v['id']));?>" style="margin-right:20px;color:green;">
                                        续费
                                    </a><a href="#">暂停</a><a onclick="return confirm('确定要关闭吗？');"  href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/del/id/'.$v['id'];?>"style="margin-left:20px;">关闭</a>
				<?php endif; ?>
                                    ...
                                    <a href="<?php echo U('show',array('id'=>$v['id']));?>" style="margin-left:-14px;color:grey;">
                                        已开通
                                    </a><a style=" margin-left: 16px;"  href="#">暂停</a><a onclick="return confirm('确定要关闭吗？');"  href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/del/id/'.$v['id'];?>"style="margin-left:20px;">关闭</a>
				<?php endif; ?>
                                 <?php if(empty($v['create_date'])): ?>
                                    <a href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/add/District/'.$v['DistrictName']."/districtid/".$v['id']; ?>" style="margin-right:20px;">
                                        开通
                                    </a><a href="#">暂停</a><a href="#"style="margin-left:20px;">关闭</a>
				<?php endif; ?>
                                <?php if(!empty($v['name'])): ?>
                                    <a style="margin-left:-12px;" href="#" style="margin-right:20px;">
                                        已开通
                                    </a><a style=" margin-left: 14px;" href="#">暂停</a><a href="<?php echo 'http://58.30.16.58/abc.php?s=admin/agent/del/id/'.$v['id'];?>"style="margin-left:20px;">关闭</a>
				<?php endif; ?>
